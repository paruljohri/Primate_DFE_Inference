...
#This is a Python script that calculates recombination rate values for vervets using 
...
#'rec_file' with input files 'LDhat_rate_estimates_' + chr_num + '_cleaned.txt'
#'exon_file' with input file "248_homo_exons_reference_with_intergenic_lengths.txt"
#first instance of 'result_file' with output file "vervet_homo_exons_recombination_interpolation.txt"
#'intergenic_file' with input file "vervet_all_intergenic_lengths.txt"
#second instance of 'result_file' with output file "vervet_all_recombination_interpolation.txt"
...
#This section reads in the vervet recombination rate map for all chromosomes at once and makes a dictionary 
...
for i in all_chr:
    chr_num = 'chr' + i
    rec_file = 'C:/Users/Kellen/Downloads/primate_dfe_project/chimp_and_vervet_data/vervet_recombination/LDhat_rate_estimates_' + chr_num + '_cleaned.txt'
...
#For the purposes of how the script works, it is useful to have a final additional map endpoint that has the same rate as the last given point
for i in all_chr:
    chr_num = 'chr' + i
...
#This section runs the script for just the 248 homologous vervet exons
...
result_file = 'C:/Users/Kellen/Downloads/primate_dfe_project/chimp_and_vervet_data/vervet_homo_exons_recombination_interpolation.txt'
...
for w in range(0, total_num_lines):
    ...
    exon_start = int(split[38])
    exon_end = int(split[39])
...
#This section runs the script for just all possible regions based on the vervet UCSC annotation.

intergenic_file = 'C:/Users/Kellen/Downloads/primate_dfe_project/vervet_all_intergenic_lengths.txt'
with open(intergenic_file, 'r') as g:
    intergenic_data = g.readlines()[1 :]
    
result_file = 'C:/Users/Kellen/Downloads/primate_dfe_project/chimp_and_vervet_data/vervet_all_recombination_interpolation.txt'
results = open(result_file, 'w+')
results.write('name' + '\t' + 'exon' + '\t' + 'chr' + '\t' + 'strand' + '\t' + 'closest_rec_start_pos' + '\t' + 'closest_rec_end_pos' + '\t' + '4Ner/kp_rec_rate' + '\t' + 'inversion_sites' + '\n')
