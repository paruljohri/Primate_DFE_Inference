...
#     human_3p_div=float(split[17])
    ...
    chimp_exon_div = float(split[37])
    chimp_5p_div = float(split[39])
    chimp_3p_div = float(split[41])
    
    vervet_exon_div = float(split[64])
    vervet_5p_div = float(split[66])
    vervet_3p_div = float(split[68])
