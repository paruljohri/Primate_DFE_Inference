...
for i in homo_exon_data:
    ...
    chimp_len = float(split[28])
    vervet_len = float(split[54])
...
human_chimp_graph = 'C:/Users/Kellen/Downloads/human_vs_chimp_exon_len_graph.pdf'
human_vervet_graph = 'C:/Users/Kellen/Downloads/human_vs_vervet_exon_len_graph.pdf'
chimp_vervet_graph = 'C:/Users/Kellen/Downloads/chimp_vs_vervet_exon_graph.pdf'
